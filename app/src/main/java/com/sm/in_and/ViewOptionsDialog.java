...
public class ViewOptionsDialog extends DialogFragment implements AdapterView.OnItemSelectedListener, DatePickerDialog.OnDateSetListener {
    private RadioGroup rgViewType;
    private RadioGroup rgViewScope;
    ...
    private ViewOptionsDialogListener listener;
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.view_options_dialog, null);

        rgViewType = view.findViewById(R.id.rgViewType);
        rgViewScope = view.findViewById(R.id.rgViewScope);
        ...
        builder.setView(view)
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        String viewScope = "";
                        String viewType = "";
                        int checkedId = rgViewScope.getCheckedRadioButtonId();
                        if(checkedId == R.id.rbAll){
                            viewScope = "all";
                        }else if(checkedId == R.id.rbInc){
                            viewScope = "inc";
                        }else if(checkedId == R.id.rbExp){
                            viewScope = "exp";
                        }
                        checkedId = rgViewType.getCheckedRadioButtonId();
                        if(checkedId == R.id.rbDet){
                            viewType = "det";
                        }else if(checkedId == R.id.rbCat){
                            viewType = "cat";
                        }
                        listener.setViewOptions(period, startDate, endDate, viewScope, viewType);
                    }
                });
    ...
    public void onAttach(@NonNull Context context) {
        ...
        listener = (ViewOptionsDialogListener) context;
    }

    public interface ViewOptionsDialogListener{
        void setViewOptions(String period, String startDate, String endDate, String viewScope, String viewType);
    }
}
